...
function NewsList({ isDarkMode }) {
  ...
  return (
    <div className="container mx-auto pb-10 py-5 md:py-10 lg:py-10 xl:py-10 px-0">
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 px-5 max-w-7xl">
